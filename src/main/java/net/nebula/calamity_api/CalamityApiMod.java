...
@Mod("calamity_api")
public class CalamityApiMod {
	public static final Logger LOGGER = LogManager.getLogger(CalamityApiMod.class);
	public static final String MODID = "calamity_api";

	public CalamityApiMod() {
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									CalamityApiMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			CalamityApiMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
